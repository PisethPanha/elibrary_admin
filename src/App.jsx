  ...
  return (
    <BrowserRouter>
      <div>
        ...
        <button onClick={() => setSidebar(!sidebar)} type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg max-xmd:block hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 ">
