...
function BookX({ read, view, download, language, type, id, img, title, describ, link, img1, img2, img3, author, publisher, publish_date }) {
    ...
    return (
            ...
            <tr className="mt-4 relative max-md:mx-auto bg-white border border-gray-200 rounded-lg shadow ">
                ...
                <div className={`w-full h-[100vh] backdrop-blur-md duration-200 fixed top-0 left-0 flex justify-center items-center z-50 ${imgZoom ? "block" : "hidden"}`}>
                    <img src={`https://raw.githubusercontent.com/PisethPanha/ebook_photos/refs/heads/main/${img1}`} alt="" className='border-4 border-gray-600 max-w-[50rem] max-h-[30rem]' />
                        ...
                        <div className=" grid items-center justify-center p-4 md:p-5 border-b rounded-t border-gray-200">
                            ...
                            <div className="grid md:grid-cols-3 gap-4 items-center justify-center">
                                ...
                                <label
                                    ...
                                    style={{
                                        background: style1 != null ? style1 : `url(https://raw.githubusercontent.com/PisethPanha/ebook_photos/refs/heads/main/${encodeURIComponent(img1)}) no-repeat center/contain`
                                    }}
                                >
                                    <input
                                        id="file-upload"
                                ...
                                <label
                                    ...
                                    className="relative flex items-center justify-center w-64 h-64 cursor-pointer rounded-xl bg-cover bg-center shadow-md"
                                    style={{
                                        background: style2 != null ? style2 : `url(https://raw.githubusercontent.com/PisethPanha/ebook_photos/refs/heads/main/${encodeURIComponent(img2)}) no-repeat center/contain`
                                    }}
                                >
                                    <input
                                        id="file-upload"
                                ...
                                <label
                                    ...
                                    className="relative flex items-center justify-center w-64 h-64 cursor-pointer rounded-xl bg-cover bg-center shadow-md"
                                    style={{
                                        background: style3 != null ? style3 : `url(https://raw.githubusercontent.com/PisethPanha/ebook_photos/refs/heads/main/${ encodeURIComponent(img3)}) no-repeat center/contain`
                                    }}
                                >
                                    <input
                                        id="file-upload"
